...
const APPEAL_COPY = {
  ...
  typeLabel: '申诉类型',
  reasonLabel: '申诉理由',
  descriptionLabel: '申诉描述',
  evidenceLabel: '申诉证据',
  taskTitle: '关联任务',
  targetTitle: '被申诉对象',
  targetFallback: '被申诉用户',
  noticeTitle: '温馨提示',
  noticeText: '平台已受理此申诉，客服将依据申诉材料与规则进行核实处理，处理结果将通过消息通知。'
}
...
Page({
  ...
  formatDetail(d) {
    ...
    return {
      ...
      reasonText: d.appealTypeLabel || d.appealType || '其他',
  ...
  formatTargetUser(targetUser = {}) {
    ...
    return {
      ...targetUser,
      id: targetUser.id || '',
      nickname: targetUser.nickname || APPEAL_COPY.targetFallback,
