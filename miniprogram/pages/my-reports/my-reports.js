    ...
    try {
      ...
      const formattedList = list.map(item => {
        ...
        return {
          ...
          displayTarget: item.reportedNickname || (item.targetUser && item.targetUser.nickname) || item.targetNickname || item.reportedUserNickname || '任务相关用户',
          displayTargetAvatar: item.reportedAvatar || (item.targetUser && item.targetUser.avatar) || item.targetAvatar || item.reportedUserAvatar || '',
